# Pro Forma Invoices Blueprint 1

- **Link name:** `Deposits_Blueprint`
- **Folder:** `pro forma invoice/`
- **Form:** `Pro_Forma_Invoices_1`
- **Start stage:** `Draft`
...
| [Payment Received Partial](transitions/Payment_Received_Partial/) | Sent | Partially Paid | 0 |
| [Payment Received Full from Sent](transitions/Payment_Received_Full_fro1/) | Sent | Paid | 0 |
| [Due Date Passed from Sent](transitions/Due_Date_Passed_from_Sent/) | Sent | Overdue | 0 |
| [Payment Received Full from Partially Paid](transitions/Payment_Received_Full_fro2/) | Partially Paid | Paid | 0 |
...
Source: `XMT___Billing_System.ds` (blueprint section for `Pro_Forma_Invoices_1`).
